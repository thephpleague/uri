...
- the [HierarchicalPath](/components/hierarchical-path/) object to work with Hierarchical paths component
- the [DataPath](/components/datauri-path/) object to work with the Data URIs path
