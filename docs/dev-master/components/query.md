...
- The query string encoding. It can be:
    - `Component::RFC3986_ENCODING`
    - `Component::RFC3987_ENCODING`
    - `Component::NO_ENCODING` if you don't want any encoding.

<p class="message-info">By default the encoding is set to <code>Component::RFC3986_ENCODING</code></p>
