...
<p class="message-info">Because the <code>League\Uri\Exception\SyntaxError</code> exception extends <code>League\Uri\Contract\UriException</code> you should catch any exception triggered by the package using the following code.</p>
