...
final class UriInfo
{
    ...
    private static function emptyComponentValue(Psr7UriInterface|UriInterface $uri): string|null
    {
     ...
     */
    public static function getOrigin(Psr7UriInterface|UriInterface $uri): string|null
    {
